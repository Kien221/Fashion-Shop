...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if($count >= 1){
      ...
      $query = "INSERT INTO user (fullname,email,phone_number,address,password,role_id) VALUE (('$fullname'),('$email'),('$phone_number'),('$address'),('$password'),'2' )";
                    ...
                    <div class="card" style="border-radius: 15px;">
                      <div class="card-body p-5">
                        ...
                        <form>
                          ...
                          <p class="text-center text-muted mt-5 mb-0">Bạn đã có tài khoản? <a href="login.php" class="fw-bold text-infor" style="text-decoration: none;">Đăng Nhập tại đây</a></p>
